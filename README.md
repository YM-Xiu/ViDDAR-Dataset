...
This is the official repository of Paper: ViDDAR: Vision Language Model-based Task-Detrimental Content Detection for Augmented Reality. The paper is accepted to IEEE VR 2025, and also accepted as a special issue of IEEE Transactions on Visualization and Computer Graphics. It contains download links and the introduction of our collected datasets.

The dataset can be found [here](https://drive.google.com/drive/folders/1aZ-2n-_DjUDqTJuQUbqMWiohOCxcp2UO?usp=drive_link).

The paper can be found [here](https://www.computer.org/csdl/journal/tg/2025/05/10924575/251sSyPifN6).
...
<table align="center">
  <tr>
    ...
    <td align="center"><img src="image/diagram_information_manipulation.png" height="210" alt="System architecture of ViDDAR for information manipulation detection"/></td>
  </tr>
  <tr>
